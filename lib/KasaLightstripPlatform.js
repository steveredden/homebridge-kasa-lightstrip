                    ...
                    for (let effect in lightstrip.effects) {
                        if(effect == "CustomEffects") {
                            for (let customEffect of lightstrip.effects[effect]) {
                                ...
                                if(!accessory) new KasaLightstripEffect(this.log, lightstrip, customEffect.json, this.api, this.debug, uuid, undefined, customEffect.name);
                                else new KasaLightstripEffect(this.log, lightstrip, customEffect.json, this.api, this.debug, undefined, accessory, customEffect.name);
                            }
                        } else {
                            ...
                            if(!accessory) new KasaLightstripEffect(this.log, lightstrip, effect, this.api, this.debug, uuid);
                            else new KasaLightstripEffect(this.log, lightstrip, effect, this.api, this.debug, undefined, accessory);
                        }
                    }
                }
            }
